...
def gbanstat(update, context):
    ...
    if len(args) > 0:
        if args[0].lower() in ["on", "yes"]:
            ...
            update.effective_message.reply_text(
                "I've disabled Spam sheild in this group. Global bans won't affect your users "
...
Spam shield uses Global bans to remove Spammers as much as possible from your chatroom!
